...
extern "C"
{
    ...
    CENGINE_API STRING* CENGINE_CALL new_string(char* str);
    CENGINE_API STRING* CENGINE_CALL str(char* str);
    ...
    CENGINE_API void    CENGINE_CALL string_substr(const STRING* str, STRING* substr, int start_pos, int length);
